...
def generate_launch_description():
    ...
    nav2_params = {
        'map_server': {
            'ros__parameters': {
                'use_sim_time': True,
                # 'yaml_filename': '/path/to/your/map.yaml'  # 👈 必须改成你实际的地图路径！
            }
        },
        ...
        'amcl': {
            'ros__parameters': {
                ...
                'global_frame_id': "map",          # ✅ 必须是 "map"！
                'odom_frame_id': "odom",
                'robot_model_type': "nav2_amcl::OmniMotionModel",  # Go2 是全向，正确
                'max_particles': 2000,
                'min_particles': 500,
                'kld_err': 0.05,
                'kld_z': 0.99,
                ...
                'laser_beams': 16,  # 可根据你的激光雷达调整
                'initial_pose': [0.0, 0.0, 0.0, 0.0],  # x, y, z, yaw
                'set_initial_pose': False,  # 如果设为 True，则从这里初始化
